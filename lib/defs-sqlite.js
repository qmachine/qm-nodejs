...
(function () {
 ...
 // Pragmas
    ...
    /*properties
        all, avar_ttl, body, '$body', '$box_key', '$box_status', cached, ceil,
        collect_garbage, Database, errno, error, '$exp_date', exports, get,
        get_avar, get_list, isWorker, join, key, '$key', length, log, map,
        nextTick, now, '$now', run, set_avar, sqlite
    */
