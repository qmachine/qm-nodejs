...
(function () {
 ...
 // Pragmas
    ...
    /*properties
        ...
        hasOwnProperty, headers, host, hostname, 'if-modified-since', ip,
        isMaster, isWorker, join, key, last_mod_date, 'Last-Modified',
        last_modified, launch, length, listen, log, match, match_hostname,
        max_fu_size, max_http_sockets, maxSockets, max_upload_size, method,
        mime_type, on, parse, pattern, persistent_storage, pid, port,
        post_box_key, push, remoteAddress, replace, slice, split, sqlite,
        static_content, status, stringify, test, timestamp, toGMTString,
        toString, trafficlog_storage, unroll, url, warn, worker_procs,
        writeHead, 'x-forwarded-for'
    */
