...
(function () {
 ...
 // Pragmas
    ...
    /*properties
        ...
        hasOwnProperty, headers, host, hostname, http_cf_ipcountry,
 ...
 // Out-of-scope definitions
    ...
    exports.launch = function (obj) {
     // This function needs documentation.
        /*jslint unparam: true */
        var config, defs, enable_cors, hang_up, log, rules, server,
            static_content;
        ...
        log = function (request) {
         // This function will redefine itself the first time it runs. It's not
         // the most efficient way to do this, but it makes the code easier to
         // organize. Ultimately, that's more important to me ;-)
            var save;
            ...
            log = function (request) {
             // This function needs documentation.
                ...
                if (request.headers.hasOwnProperty('http_cf_ipcountry')) {
                 // This header is specific to CloudFlare (www.cloudflare.com).
                    data.http_cf_ipcountry = request.headers.http_cf_ipcountry;
                }
