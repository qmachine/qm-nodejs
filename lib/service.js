...
(function () {
 ...
 // Pragmas
    ...
    /*properties
        ...
        key, last_mod_date, 'Last-Modified', last_modified, launch, length,
        listen, log, match, match_hostname, max_fu_size, max_http_sockets,
        maxSockets, max_upload_size, method, mime_type, on, parse, pattern,
        persistent_storage, pid, port, push, replace, set_avar, slice, split,
        sqlite, static_content, status, stringify, test, timestamp,
        toGMTString, toString, trafficlog_storage, unroll, url, warn,
        worker_procs, writeHead, 'x-forwarded-for'
    */
    ...
    exports.launch = function (obj) {
     // This function needs documentation.
        ...
        if (config.trafficlog_storage.hasOwnProperty('couch')) {
            ...
            save = function (obj) {
             // This function prints traffic data to stdout.
        ...
        if (config.enable_api_server === true) {
         ...
         // These are mainly here for debugging at the moment ...
            ...
            if (config.enable_www_server === false) {
