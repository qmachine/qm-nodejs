...
(function () {
 ...
 // Pragmas
    ...
    /*properties
        ...
        find, findOne, get_avar, get_list, isWorker, key, length, log, mongo,
        MongoClient, on, push, safe, save, set_avar, stream, update, upsert
    */
         ...
         // This function is a LOT simpler than what I had before!
            ...
            db.collection('avars').ensureIndex('exp_date', {
             ...
             // This function needs documentation.
                ...
                db.collection('avars').ensureIndex('box_status', options, f);
