...
(function () {
 ...
 // Pragmas
    ...
    /*properties
        ...
        fields, find, findAndModify, gc_interval, get_avar, get_list, '_id',
        insert, isWorker, key, length, log, '$lt', mongo, MongoClient, now, on,
        push, remove, safe, '$set', set_avar, sparse, stream, update, upsert
    */
        ...
        get_avar = function (params, callback) {
         ...
         // so that data still being used for computations will not be removed.
            ...
            db.collection('avars').findAndModify(query, [],
                ...
                {'fields': {'body': 1, '_id': 0}, 'upsert': false}, f);
            return;
        };
