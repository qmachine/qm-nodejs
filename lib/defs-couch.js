...
(function () {
 ...
 // Pragmas
    ...
    /*properties
        ...
        couch, create, end, error, exp_date, get_avar, get_list, headers, _id,
        isMaster, join, key, keys, length, log, method, now, on, parse,
        protocol, push, request, _rev, set_avar, statusCode, stringify,
        toString, trim
    */
 ...
 // Out-of-scope definitions
    ...
    exports.api = function (options) {
     // This function needs documentation.
        ...
        var app_url, collect_garbage, conn, exp_date, get_avar, get_list,
            protocol, set_avar;
