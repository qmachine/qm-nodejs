...
(function () {
 ...
 // Pragmas
    ...
    /*properties
        ...
        get_list, hasOwnProperty, isMaster, isWorker, join, key, length, log,
        map, native, persistent_storage, postgres, push, query, rows, set_avar,
        stringify, trafficlog_storage
    */
