...
(function () {
 ...
 // Pragmas
    ...
    /*properties
        all, avar_ttl, body, '$body', '$box', cached, ceil, collect_garbage,
        Database, '$ed', errno, error, '$exp_date', exports, get, get_avar,
        get_list, isMaster, join, key, '$key', length, log, map, nextTick, now,
        '$now', run, set_avar, shift, slice, sqlite, split, '$status'
    */
