...
(function () {
 ...
 // Pragmas
    ...
    /*properties
        ...
        get_avar, get_list, '$gt', '_id', insert, isWorker, key, length, log,
        '$lt', mongo, MongoClient, now, on, persistent_storage, push, remove,
        safe, '$set', set_avar, status, stream, trafficlog_storage, unique,
        update, upsert
    */
