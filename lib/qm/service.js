...
(function () {
 ...
 // Pragmas
    ...
    /*properties
        ...
        'content-length', 'Content-Type', create, createServer, cwd, Date,
        ...
        persistent_storage, pid, port, push, replace, set_avar, slice, sort,
        split, sqlite, static_content, status, stringify, test, timestamp,
        toString, toUTCString, trafficlog_storage, unroll, url, warn,
        worker_procs, writeHead
    */
    ...
    exports.launch = function (obj) {
     // This function needs documentation.
        ...
        config = configure(obj, {
            ...
            persistent_storage: {},
            port:               8177,
            static_content:     path.join(process.cwd(), 'katamari.json'),
            trafficlog_storage: {},
            worker_procs:       1
        });
