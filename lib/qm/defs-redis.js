...
(function () {
 ...
 // Pragmas
    ...
    /*properties
        auth, avar_ttl, body, ceil, collect_garbage, createClient,
        detect_buffers, enable_offline_queue, error, exec, exists, expire,
        exports, forEach, get_avar, get_list, hget, hmset, hostname, isMaster,
        keys, length, log, multi, no_ready_check, on, parse, parser, port,
        quit, redis, replace, return_buffers, sadd, set_avar, smembers,
        socket_nodelay, split, srem, status
    */
