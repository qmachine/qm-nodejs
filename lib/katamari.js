...
(function () {
 ...
 // Pragmas
    ...
    /*properties
        avar, base64, buffer, error, exit, extname, fail, forEach,
        hasOwnProperty, isDirectory, isFile, join, last_mod_date,
        last_modified, length, log, lstat, mime_type, normalize, on, Q,
        readdir, readFile, roll_up, stringify, test, toGMTString, toString,
        unroll, val, writeFile, '', '.appcache', '.css', '.html', '.ico',
        '.jpg', '.js', '.json', '.manifest', '.png', '.txt', '.webapp', '.xml'
    */

 // Declarations

    var avar, fs, ignore_patterns, mime_types, path, roll_up, unroll;
